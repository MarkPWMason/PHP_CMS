    ...
    foreach ($_POST['checkBoxArray'] as $postValueId) {
        ...
        switch ($bulk_options) {
            ...
            case 'clone':
                ...
                VALUES ({$post_category_id}, '{$post_title}','{$post_author}', now(), '{$post_status}', '{$post_image}', '{$post_tags}', '{$post_content}')";
...
<table class="table table-bordered table-hover">
    <div style="padding: 0px" id="bulkOptionsContainer" class="col-xs-4">
...
while ($row = mysqli_fetch_assoc($selectPosts)) {
    ...
    while ($row = mysqli_fetch_array($selectCategoriesId)) {
        $cat_id = $row['cat_id'];
