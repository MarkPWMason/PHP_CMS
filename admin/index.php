      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Date', 'Count'],
            ...
            $element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comment_counts, $comment_unapproved_counts, $user_counts, $user_subscriber_counts, $category_counts];
